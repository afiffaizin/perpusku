    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <div class="login-left-content">
                <div style="width:72px;height:72px;background:rgba(255,255,255,0.12);border-radius:var(--radius-lg);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;">
                    <i class="bi bi-book-half" style="font-size:32px;color:white;"></i>
                </div>
                <h2 style="font-size:28px;font-weight:700;margin-bottom:8px;letter-spacing:-0.01em;">perpus·TRPL</h2>
                <p style="font-size:14px;color:#C7D2FE;line-height:1.7;margin-bottom:40px;">
                    Kelola perpustakaan TRPL dengan lebih efisien.<br>
                    Sistem manajemen modern untuk buku, mahasiswa, dan peminjaman.
                </p>
                {{-- SVG illustration: bookshelves --}}
                <svg viewBox="0 0 300 160" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:260px;opacity:0.6;margin:0 auto;">
        ...
        <div class="login-right">
            <div class="login-form-box">
                <div class="d-lg-none text-center mb-4">
                    <div style="width:56px;height:56px;background:var(--sidebar-bg);border-radius:var(--radius-lg);display:inline-flex;align-items:center;justify-content:center;margin-bottom:8px;">
                        <i class="bi bi-book-half" style="font-size:24px;color:white;"></i>
                    </div>
                </div>

                <div class="text-center mb-4">
                    <h3 style="font-size:24px;font-weight:700;color:var(--clr-text);margin-bottom:4px;">Selamat datang kembali</h3>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position:relative;">
                            <i class="bi bi-envelope" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--clr-muted);font-size:16px;"></i>
                    ...
                    <div class="mb-4">
                        ...
                        <div style="position:relative;">
                            <i class="bi bi-lock" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--clr-muted);font-size:16px;"></i>
                    ...
                    <button type="submit" class="btn-primary-custom w-100 justify-content-center" style="height:46px;font-size:15px;">
