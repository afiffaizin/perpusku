...
<head>
    ...
    <title>@yield('title', 'Perpustakaan') — Perpusku</title>
    ...
    <div class="min-h-full">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
                ...
                <div>
                    <h1 class="text-sm font-bold text-gray-900">Perpusku</h1>
            ...
            <header class="sticky top-0 z-30 bg-white/80 backdrop-blur-sm border-b border-gray-200">
                <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
                    ...
                    <div class="flex items-center gap-3">
                        <span
                            class="text-sm text-gray-500 hidden sm:block">{{ now()->translatedFormat('l, d F Y') }}</span>
                    </div>
                </div>
            </header>
