...
@section('content')
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span class="text-gray-900 font-medium">Tambah Mahasiswa</span>
    </nav>

    <div class="max-w-2xl">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <form action="{{ route('admin.storeMahasiswa') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-600 text-sm font-medium rounded-lg transition-colors">Kembali</a>
                </div>
            </form>
        </div>
    </div>
