    ...
    <div class="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-slate-800 relative items-center justify-center p-12">
            ...
            <div class="relative z-10 text-center">
                <div
                    class="flex items-center justify-center w-20 h-20 bg-white/10 backdrop-blur rounded-2xl mx-auto mb-8">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                </div>
                <h2 class="text-2xl font-bold text-white mb-3">Perpusku</h2>
                <p class="text-slate-300 text-sm leading-relaxed">Sistem Manajemen Perpustakaan<br>Program Studi TRPL
                </p>
